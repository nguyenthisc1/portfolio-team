...
function Table({ className, containerClassName, ...props }: TableProps) {
    ...
    return (
        <div className="bg-background-secondary relative grid overflow-hidden rounded-md border">
            <div
...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
    return (
        <thead
            ...
            className={cn('sticky top-0 z-[2]', className)}
            {...props}
        />
    )
}
...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
    return (
        <tfoot
            ...
            className={cn('sticky bottom-0 border-t bg-neutral-400/10 font-medium', className)}
            {...props}
        />
    )
}
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
    return (
        <th
            ...
            className={cn(
                'text-foreground bg-background-tertiary h-10 px-3 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
                className,
            )}
            {...props}
        />
...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
    return (
        <td
            ...
            className={cn(
                'truncate bg-inherit p-3 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
                className,
            )}
            {...props}
        />
